...
from backend.models import AutomationTemplateModel, Base
...
if __name__ == "__main__":
    ...
    # Load all URLs from the template JSON file
    file_path = os.path.join(os.path.dirname(__file__), "templates_zapier.json")
    try:
